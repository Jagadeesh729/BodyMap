...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205501%2F5501-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,501 automated unit & oracle tests across 140 suites)
...
│   ├── __tests__/           # 140 Vitest unit test & oracle suites (5,501 tests)
...
| `npm run test` | Executes 5,501 automated Vitest tests across 140 suites |
