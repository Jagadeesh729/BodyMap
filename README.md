...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205248%2F5248-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,248 automated unit & oracle tests across 130 suites)
...
│   ├── __tests__/           # 130 Vitest unit test & oracle suites (5,248 tests)
...
| `npm run test` | Executes 5,248 automated Vitest tests across 130 suites |
