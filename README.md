...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205158%2F5158-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,158 automated unit & oracle tests across 124 suites)
...
│   ├── __tests__/           # 124 Vitest unit test & oracle suites (5,158 tests)
...
| `npm run test` | Executes 5,158 automated Vitest tests across 124 suites |
