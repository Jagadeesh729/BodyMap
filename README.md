...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205209%2F5209-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,209 automated unit & oracle tests across 128 suites)
...
│   ├── __tests__/           # 128 Vitest unit test & oracle suites (5,209 tests)
...
| `npm run test` | Executes 5,209 automated Vitest tests across 128 suites |
