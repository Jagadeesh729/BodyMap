...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205526%2F5526-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,526 automated unit & oracle tests across 141 suites)
...
│   ├── __tests__/           # 141 Vitest unit test & oracle suites (5,526 tests)
...
| `npm run test` | Executes 5,526 automated Vitest tests across 141 suites |
