...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205991%2F5991-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,991 automated unit & oracle tests across 157 suites)
- **Deployment**: [Vercel](https://vercel.com/) (Edge network with automatic HTTPS and asset caching)
...
│   ├── __tests__/           # 157 Vitest unit test & oracle suites (5,991 tests)
...
| `npm run test` | Executes 5,991 automated Vitest tests across 157 suites |
