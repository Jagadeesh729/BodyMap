...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205287%2F5287-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,287 automated unit & oracle tests across 133 suites)
...
│   ├── __tests__/           # 133 Vitest unit test & oracle suites (5,287 tests)
...
| `npm run test` | Executes 5,287 automated Vitest tests across 133 suites |
