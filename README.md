...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%2037%2F37-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library + jsdom (37 unit tests)
...
│   ├── __tests__/           # 7 Vitest unit test suites (37 tests)
...
| `npm run test` | Executes 37 automated Vitest unit tests across 7 test suites |
