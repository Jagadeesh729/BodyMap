...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205918%2F5918-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,918 automated unit & oracle tests across 157 suites)
...
│   ├── __tests__/           # 157 Vitest unit test & oracle suites (5,918 tests)
...
| `npm run test` | Executes 5,918 automated Vitest tests across 157 suites |
