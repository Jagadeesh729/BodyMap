...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205661%2F5661-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,661 automated unit & oracle tests across 146 suites)
...
│   ├── __tests__/           # 146 Vitest unit test & oracle suites (5,661 tests)
...
| `npm run test` | Executes 5,661 automated Vitest tests across 146 suites |
