...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205231%2F5231-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,231 automated unit & oracle tests across 129 suites)
...
│   ├── __tests__/           # 129 Vitest unit test & oracle suites (5,231 tests)
...
| `npm run test` | Executes 5,231 automated Vitest tests across 129 suites |
