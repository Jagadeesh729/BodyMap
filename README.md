...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205736%2F5736-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,736 automated unit & oracle tests across 149 suites)
...
│   ├── __tests__/           # 149 Vitest unit test & oracle suites (5,736 tests)
...
| `npm run test` | Executes 5,736 automated Vitest tests across 149 suites |
