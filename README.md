...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205407%2F5407-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,407 automated unit & oracle tests across 138 suites)
...
│   ├── __tests__/           # 138 Vitest unit test & oracle suites (5,407 tests)
...
| `npm run test` | Executes 5,407 automated Vitest tests across 138 suites |
