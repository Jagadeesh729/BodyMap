...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%201042%2F1042-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (1042 unit tests across 99 suites)
...
│   ├── __tests__/           # 99 Vitest unit test suites (1042 tests)
...
| `npm run test` | Executes 1042 automated Vitest unit tests across 99 suites |
