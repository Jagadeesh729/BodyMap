...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205247%2F5247-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,247 automated unit & oracle tests across 130 suites)
...
│   ├── __tests__/           # 130 Vitest unit test & oracle suites (5,247 tests)
...
| `npm run test` | Executes 5,247 automated Vitest tests across 130 suites |
