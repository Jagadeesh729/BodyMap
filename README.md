...
[![Vitest](https://img.shields.io/badge/Vitest-Passed%205694%2F5694-00FF88?style=for-the-badge&logo=vitest&logoColor=black)](https://vitest.dev/)
...
- **Testing**: [Vitest 4.1.11](https://vitest.dev/) + React Testing Library (5,694 automated unit & oracle tests across 147 suites)
...
│   ├── __tests__/           # 147 Vitest unit test & oracle suites (5,694 tests)
...
| `npm run test` | Executes 5,694 automated Vitest tests across 147 suites |
