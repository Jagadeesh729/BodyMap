...
describe('API Abuse Resistance & Economic DoS Protection Oracle (500 Tests)', () => {
  ...
  describe('Section A: Request Admission & Method/Content-Type Enforcement', () => {
    ...
    it('A16: OPTIONS preflight from https://example.com returns 204 without CORS headers (unauthorized)', async () => {
    ...
    it('A19: OPTIONS preflight from null returns 204 without CORS headers (denied)', async () => {
    ...
    it('A20: OPTIONS preflight from https://malicious.origin.com returns 204 without CORS headers (denied)', async () => {
  ...
  describe('Section I: CORS & Origin Surface Testing', () => {
    it('I01: origin "https://bodymap-ai.vercel.app" receives exact Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I02: origin "http://localhost:8080" receives exact Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I03: origin "http://127.0.0.1:8080" receives exact Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
      const req = createMockReq('POST', { formData: baseValidFormData }, { origin: 'http://127.0.0.1:8080' }, '10.800.1.2')
      const res = createMockRes()
      await handler(req, res)
      expect(res.statusCode).toBe(200)
      expect(res.getHeader('Access-Control-Allow-Origin')).toBe('http://127.0.0.1:8080')
      expect(res.getHeader('Access-Control-Allow-Credentials')).toBeUndefined()
    })
    it('I04: origin "https://attacker.site" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I05: origin "https://thirdparty.app" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I06: origin "null" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I07: origin "chrome-extension://xyz" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I08: origin "http://evil.com" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I09: origin "https://trusted.partner.org" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I10: origin "https://subdomain.bodymap-ai.vercel.app" receives NO Access-Control-Allow-Origin on POST', async () => {
      vi.stubGlobal('fetch', mockGeminiSuccess())
    ...
    it('I11: origin "https://bodymap-ai.vercel.app" receives 204 with exact ACAO on preflight OPTIONS', async () => {
    ...
    it('I12: origin "http://localhost:8080" receives 204 with exact ACAO on preflight OPTIONS', async () => {
    ...
    it('I13: origin "http://127.0.0.1:8080" receives 204 with exact ACAO on preflight OPTIONS', async () => {
    ...
    it('I14: origin "https://attacker.site" receives 204 without ACAO on preflight OPTIONS', async () => {
    ...
    it('I15: origin "https://thirdparty.app" receives 204 without ACAO on preflight OPTIONS', async () => {
    ...
    it('I16: origin "null" receives 204 without ACAO on preflight OPTIONS', async () => {
    ...
    it('I17: origin "chrome-extension://xyz" receives 204 without ACAO on preflight OPTIONS', async () => {
    ...
    it('I18: origin "http://evil.com" receives 204 without ACAO on preflight OPTIONS', async () => {
    ...
    it('I19: origin "https://trusted.partner.org" receives 204 without ACAO on preflight OPTIONS', async () => {
    ...
    it('I20: origin "https://subdomain.bodymap-ai.vercel.app" receives 204 without ACAO on preflight OPTIONS', async () => {
