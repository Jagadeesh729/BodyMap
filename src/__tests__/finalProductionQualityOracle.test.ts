...
describe('Section G: Documentation & Contract Synchronization', () => {
  it('G01-G15: Synchronized test counts and evidence-based claims in README.md', () => {
    ...
    expect(readme).not.toContain('147 Vitest')
    ...
    expect(readme).not.toContain('143 Vitest')
    expect(readme).not.toContain('5,526')
    expect(readme).not.toContain('5526')
    expect(readme).not.toContain('141 suites')
    expect(readme).not.toContain('141 Vitest')
    expect(readme).not.toContain('5,501')
    expect(readme).not.toContain('5501')
    expect(readme).not.toContain('140 suites')
    expect(readme).not.toContain('140 Vitest')
    expect(readme).not.toContain('5,168')
    expect(readme).not.toContain('5168')
    expect(readme).not.toContain('124 suites')
    expect(readme).not.toContain('124 Vitest')
    ...
    expect(contract.currentHeadCommit).not.toBe('48a07cb993e408d6d8773fb5cf0444e8ed02fc93')
    expect(contract.currentHeadCommit).not.toBe('eec15c81e107c1e36d369a2e388d84c08280e076')
    expect(contract.currentHeadCommit).not.toBe('31587797c43e3b27d33d610a2983b63109e7435b') // E28-A (superseded)
    expect(contract.currentHeadCommit).not.toBe('036e7c141992fa318b12db1a0b8482d8b2d7ba2f') // transient amend (superseded)
    expect(contract.currentHeadCommit).not.toBe('8cc50d725b7546ff2d804be2fa7977c436e176e4') // transient amend (superseded)
    expect(contract.currentHeadCommit).not.toBe('e802f79530246bd245cf7c4a9398507f22f6834d') // E28-B governance fix (superseded by final certified lineage)
    expect(contract.currentHeadCommit).not.toBe('2aa7146e0339dae656ba4071b90f46452d7df647') // superseded by final certified lineage
    ...
    expect(contract.currentHeadCommit).not.toBe('5f87d279c109329f2ba0a84db3ba7aa70c59ea47') // superseded by final certified lineage
    expect(contract.currentHeadCommit).toBe('8a1fae81437056359309eac6b099bc93be619656')
