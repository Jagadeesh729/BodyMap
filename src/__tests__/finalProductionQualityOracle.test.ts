...
describe('Section G: Documentation & Contract Synchronization', () => {
  it('G01-G15: Synchronized test counts and evidence-based claims in README.md', () => {
    ...
    expect(readme).not.toContain('5941')
    expect(readme).not.toContain('5,921')
    expect(readme).not.toContain('5921')
    expect(readme).not.toContain('5,918')
    expect(readme).not.toContain('5918')
    expect(readme).not.toContain('5,877')
    expect(readme).not.toContain('5877')
